...
import org.pouyadr.ui.Components.ForegroundDetector;
...
public class ApplicationLoader extends MultiDexApplication {
    ...
    public static File getFilesDirFixed() {
        ...
        return new File("/data/data/org.pouyadr.messenger/files");
    }
    ...
    public void onCreate() {
        ...
        applicationContext.startService(new Intent(applicationContext, MyFirebaseMessagingService.class));
