 ...
 */
package org.pouyadr.messenger.exoplayer.extractor;

import org.pouyadr.messenger.exoplayer.C;
import org.pouyadr.messenger.exoplayer.MediaFormat;
import org.pouyadr.messenger.exoplayer.MediaFormatHolder;
import org.pouyadr.messenger.exoplayer.ParserException;
import org.pouyadr.messenger.exoplayer.SampleHolder;
import org.pouyadr.messenger.exoplayer.SampleSource;
import org.pouyadr.messenger.exoplayer.SampleSource.SampleSourceReader;
import org.pouyadr.messenger.exoplayer.TrackRenderer;
import org.pouyadr.messenger.exoplayer.drm.DrmInitData;
import org.pouyadr.messenger.exoplayer.upstream.Allocator;
import org.pouyadr.messenger.exoplayer.upstream.DataSource;
import org.pouyadr.messenger.exoplayer.upstream.DataSpec;
import org.pouyadr.messenger.exoplayer.upstream.Loader;
import org.pouyadr.messenger.exoplayer.upstream.Loader.Loadable;
import org.pouyadr.messenger.exoplayer.util.Assertions;
import org.pouyadr.messenger.exoplayer.util.Util;
 ...
 *
 * <ul>
 * <li>MP4, including M4A ({@link org.pouyadr.messenger.exoplayer.extractor.mp4.Mp4Extractor})</li>
 * <li>fMP4 ({@link org.pouyadr.messenger.exoplayer.extractor.mp4.FragmentedMp4Extractor})</li>
 * <li>Matroska and WebM ({@link org.pouyadr.messenger.exoplayer.extractor.webm.WebmExtractor})</li>
 * <li>Ogg Vorbis/FLAC ({@link org.pouyadr.messenger.exoplayer.extractor.ogg.OggExtractor}</li>
 * <li>MP3 ({@link org.pouyadr.messenger.exoplayer.extractor.mp3.Mp3Extractor})</li>
 * <li>AAC ({@link org.pouyadr.messenger.exoplayer.extractor.ts.AdtsExtractor})</li>
 * <li>MPEG TS ({@link org.pouyadr.messenger.exoplayer.extractor.ts.TsExtractor})</li>
 * <li>MPEG PS ({@link org.pouyadr.messenger.exoplayer.extractor.ts.PsExtractor})</li>
 * <li>FLV ({@link org.pouyadr.messenger.exoplayer.extractor.flv.FlvExtractor})</li>
 * <li>WAV ({@link org.pouyadr.messenger.exoplayer.extractor.wav.WavExtractor})</li>
  ...
  static {
    ...
    try {
      DEFAULT_EXTRACTOR_CLASSES.add(
          Class.forName("org.pouyadr.messenger.exoplayer.extractor.webm.WebmExtractor")
    ...
    try {
      DEFAULT_EXTRACTOR_CLASSES.add(
          Class.forName("org.pouyadr.messenger.exoplayer.extractor.mp4.FragmentedMp4Extractor")
              .asSubclass(Extractor.class));
    } catch (ClassNotFoundException e) {
      // Extractor not found.
    }
    try {
      DEFAULT_EXTRACTOR_CLASSES.add(
          Class.forName("org.pouyadr.messenger.exoplayer.extractor.mp4.Mp4Extractor")
              .asSubclass(Extractor.class));
    } catch (ClassNotFoundException e) {
      // Extractor not found.
    }
    try {
      DEFAULT_EXTRACTOR_CLASSES.add(
          Class.forName("org.pouyadr.messenger.exoplayer.extractor.mp3.Mp3Extractor")
              .asSubclass(Extractor.class));
    } catch (ClassNotFoundException e) {
      // Extractor not found.
    }
    try {
      DEFAULT_EXTRACTOR_CLASSES.add(
          Class.forName("org.pouyadr.messenger.exoplayer.extractor.ts.AdtsExtractor")
              .asSubclass(Extractor.class));
    } catch (ClassNotFoundException e) {
      // Extractor not found.
    }
    try {
      DEFAULT_EXTRACTOR_CLASSES.add(
          Class.forName("org.pouyadr.messenger.exoplayer.extractor.ts.TsExtractor")
              .asSubclass(Extractor.class));
    } catch (ClassNotFoundException e) {
      // Extractor not found.
    }
    try {
      DEFAULT_EXTRACTOR_CLASSES.add(
          Class.forName("org.pouyadr.messenger.exoplayer.extractor.flv.FlvExtractor")
              .asSubclass(Extractor.class));
    } catch (ClassNotFoundException e) {
      // Extractor not found.
    }
    try {
      DEFAULT_EXTRACTOR_CLASSES.add(
          Class.forName("org.pouyadr.messenger.exoplayer.extractor.ogg.OggExtractor")
              .asSubclass(Extractor.class));
    } catch (ClassNotFoundException e) {
      // Extractor not found.
    }
    try {
      DEFAULT_EXTRACTOR_CLASSES.add(
          Class.forName("org.pouyadr.messenger.exoplayer.extractor.ts.PsExtractor")
              .asSubclass(Extractor.class));
    } catch (ClassNotFoundException e) {
      // Extractor not found.
    }
    try {
      DEFAULT_EXTRACTOR_CLASSES.add(
          Class.forName("org.pouyadr.messenger.exoplayer.extractor.wav.WavExtractor")
              .asSubclass(Extractor.class));
    } catch (ClassNotFoundException e) {
      // Extractor not found.
    }
    try {
      DEFAULT_EXTRACTOR_CLASSES.add(
          Class.forName("org.pouyadr.messenger.exoplayer.ext.flac.FlacExtractor")
              .asSubclass(Extractor.class));
    } catch (ClassNotFoundException e) {
      // Extractor not found.
    }
