 ...
 */
package org.pouyadr.messenger.exoplayer.text;

import org.pouyadr.messenger.exoplayer.ExoPlaybackException;
...
import org.pouyadr.messenger.exoplayer.SampleSourceTrackRenderer;
 ...
 *
 * <ul>
 * <li>WebVTT ({@link org.pouyadr.messenger.exoplayer.text.webvtt.WebvttParser})</li>
 * <li>TTML
 * ({@link org.pouyadr.messenger.exoplayer.text.ttml.TtmlParser})</li>
 * <li>SubRip
 * ({@link org.pouyadr.messenger.exoplayer.text.subrip.SubripParser})</li>
 * <li>TX3G
 * ({@link org.pouyadr.messenger.exoplayer.text.tx3g.Tx3gParser})</li>
 * </ul>
 *
  ...
  static {
    ...
    try {
      DEFAULT_PARSER_CLASSES.add(
          Class.forName("org.pouyadr.messenger.exoplayer.text.webvtt.WebvttParser")
    ...
    try {
      DEFAULT_PARSER_CLASSES.add(
          Class.forName("org.pouyadr.messenger.exoplayer.text.ttml.TtmlParser")
              .asSubclass(SubtitleParser.class));
    } catch (ClassNotFoundException e) {
      // Parser not found.
    }
    try {
      DEFAULT_PARSER_CLASSES.add(
          Class.forName("org.pouyadr.messenger.exoplayer.text.webvtt.Mp4WebvttParser")
              .asSubclass(SubtitleParser.class));
    } catch (ClassNotFoundException e) {
      // Parser not found.
    }
    try {
      DEFAULT_PARSER_CLASSES.add(
          Class.forName("org.pouyadr.messenger.exoplayer.text.subrip.SubripParser")
              .asSubclass(SubtitleParser.class));
    } catch (ClassNotFoundException e) {
      // Parser not found.
    }
    try {
      DEFAULT_PARSER_CLASSES.add(
          Class.forName("org.pouyadr.messenger.exoplayer.text.tx3g.Tx3gParser")
              .asSubclass(SubtitleParser.class));
    } catch (ClassNotFoundException e) {
      // Parser not found.
    }
