 ...
 */
package org.pouyadr.messenger.exoplayer;

import org.pouyadr.messenger.exoplayer.MediaCodecUtil.DecoderQueryException;
import org.pouyadr.messenger.exoplayer.drm.DrmInitData;
import org.pouyadr.messenger.exoplayer.drm.DrmSessionManager;
import org.pouyadr.messenger.exoplayer.util.Assertions;
import org.pouyadr.messenger.exoplayer.util.NalUnitUtil;
import org.pouyadr.messenger.exoplayer.util.TraceUtil;
...
public abstract class MediaCodecTrackRenderer extends SampleSourceTrackRenderer {
  ...
  public static class DecoderInitializationException extends Exception {
    ...
    private static String buildCustomDiagnosticInfo(int errorCode) {
      ...
      return "org.pouyadr.messenger.exoplayer.MediaCodecTrackRenderer_" + sign + Math.abs(errorCode);
    }
