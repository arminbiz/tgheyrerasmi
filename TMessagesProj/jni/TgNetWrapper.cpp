...
static const char *NativeByteBufferClassPathName = "org/pouyadr/tgnet/NativeByteBuffer";
...
static const char *ConnectionsManagerClassPathName = "org/pouyadr/tgnet/ConnectionsManager";
static JNINativeMethod ConnectionsManagerMethods[] = {
        ...
        {"native_sendRequest", "(ILorg/pouyadr/tgnet/RequestDelegateInternal;Lorg/pouyadr/tgnet/QuickAckDelegate;IIIZI)V", (void *) sendRequest},
...
extern "C" int registerNativeTgNetFunctions(JavaVM *vm, JNIEnv *env) {
    ...
    jclass_RequestDelegateInternal = (jclass) env->NewGlobalRef(env->FindClass("org/pouyadr/tgnet/RequestDelegateInternal"));
    ...
    jclass_QuickAckDelegate = (jclass) env->NewGlobalRef(env->FindClass("org/pouyadr/tgnet/QuickAckDelegate"));
    if (jclass_RequestDelegateInternal == 0) {
        return JNI_FALSE;
    }
    ...
    jclass_ConnectionsManager = (jclass) env->NewGlobalRef(env->FindClass("org/pouyadr/tgnet/ConnectionsManager"));
